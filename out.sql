...
CREATE TABLE `external_id` (`id` INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE NOT NULL, `recording_id` TEXT NOT NULL REFERENCES `recording`(`id`), `ext_id` TEXT NOT NULL, `service` TEXT NOT NULL, `user_overwrite` TEXT) STRICT;
